...
SENSORS: tuple[PVLimiterSensorDescription, ...] = (
    ...
    PVLimiterSensorDescription(
        key="budget_used_kwh",
        translation_key="budget_used_kwh",
        icon="mdi:counter",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        suggested_display_precision=2,
        value_fn=lambda s: round(s.budget_used_kwh, 3),
    ),
    PVLimiterSensorDescription(
        key="budget_remaining_kwh",
        translation_key="budget_remaining_kwh",
        icon="mdi:battery-arrow-down",
        device_class=SensorDeviceClass.ENERGY,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        suggested_display_precision=2,
        value_fn=lambda s: round(s.budget_remaining_kwh, 3),
    ),
    PVLimiterSensorDescription(
        key="budget_remaining_pct",
        translation_key="budget_remaining_pct",
        icon="mdi:percent-outline",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        suggested_display_precision=0,
        value_fn=lambda s: round(s.budget_remaining_pct, 1),
    ),
)
